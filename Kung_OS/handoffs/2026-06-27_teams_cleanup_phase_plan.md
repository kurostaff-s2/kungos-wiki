...
### teams/ Cleanup Complete (2026-06-27 17:15 UTC)
- All teams/ files deleted (except management commands)
- All functions migrated to domains/
- 'teams' removed from INSTALLED_APPS in backend/settings.py
- teams/ directory now only contains management commands
